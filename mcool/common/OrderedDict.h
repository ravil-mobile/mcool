...
template <typename Key, typename Value>
OrderedDict<Key, Value>::OrderedDict(const OrderedDict& other) : index_(other.index_) {
...
template <typename Key, typename Value>
OrderedDict<Key, Value>& OrderedDict<Key, Value>::operator=(const OrderedDict& other) {
  index_ = other.index_;
  items_.clear();
...
template <typename Key, typename Value>
OrderedDict<Key, Value>::OrderedDict(std::initializer_list<Item> initializer_list) {
...
template <typename Key, typename Value>
typename OrderedDict<Key, Value>::ConstIterator OrderedDict<Key, Value>::begin() const {
  return items_.begin();
}
...
template <typename Key, typename Value>
typename OrderedDict<Key, Value>::ConstIterator OrderedDict<Key, Value>::end() const {
  return items_.end();
}
...
template <typename Key, typename Value>
const typename OrderedDict<Key, Value>::Item& OrderedDict<Key, Value>::front() const {
  assert(!items_.empty() && "Called front() on an empty OrderedDict");
  return items_.front();
}
...
template <typename Key, typename Value>
const typename OrderedDict<Key, Value>::Item& OrderedDict<Key, Value>::back() const {
  assert(!items_.empty() && "Called back() on an empty OrderedDict");
  return items_.back();
}

template <typename Key, typename Value>
typename OrderedDict<Key, Value>::Item& OrderedDict<Key, Value>::operator[](size_t index) {
  assert(index < items_.size() && "Index is out of bounds");
  return items_[index];
}

template <typename Key, typename Value>
const typename OrderedDict<Key, Value>::Item&
    OrderedDict<Key, Value>::operator[](size_t index) const {
  assert(index < items_.size() && "Index is out of bounds");
  return items_[index];
}
...
template <typename Key, typename Value>
const std::vector<typename OrderedDict<Key, Value>::Item>&
    OrderedDict<Key, Value>::items() const noexcept {
  return items_;
}
